...
                        <span> 如遇问题，请联系站长 </span> </span> <span class="fk_service_button" onclick="window.open('https://wpa.qq.com/msgrd?v=3&uin=508431871&site=qq&menu=yes')">QQ联系</span>

                    <span class="fk_service_button" onclick="window.open('https://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=508431871@qq.com')">在线邮件</span>

                </div> <span class="fk_service_phone"> QQ 请注明来意 ：508431871 </span> <span class="fk_service_check_site"> <span class="fk_service_icon"></span>

                    <span onclick="window.open('https://www.886a.top')">更多：羽翼博客</span> </span>
...
        <li class="fk_service_box fk_service_ax" onclick="window.open('https://www.886a.top')">
...
        <li class="fk_service_box fk_service_dh" onclick="window.open('https://www.886a.top')">
...
        <li class="fk_service_box fk_service_jk" onclick="window.open('https://www.886a.top')">
...
        <li class="fk_service_box fk_service_ws" onclick="window.open('https://www.886a.top')">
...
        <li class="fk_service_box fk_service_sd" onclick="window.open('https://www.886a.top')">
...
        <li class="fk_service_box fk_service_dz" onclick="window.open('https://www.886a.top')">

            <div class="fk_service_dz_cont"> <span class="fk_service_triangle"></span> 提交收录，站长收到留言后即刻处理！ </div>

        </li>

        <li class="fk_service_box fk_service_feedback" onclick="window.open('https://we.dog')">

            <div class="fk_service_feedback_cont"> <span class="fk_service_triangle"></span> 日记 </div>
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -366px -16px #fff
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -410px -16px #4f7cfc
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -460px -25px;
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -461px -75px;
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -363px -64px #fff
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -407px -64px #4f7cfc;
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -365px -113px #fff
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -409px -113px #4f7cfc
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -41px -26px
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -198px -26px
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -41px -177px
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -198px -177px
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -41px -326px
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -363px -159px #fff
...
        background: url(https://for.886a.top/wp-content/pict/gzh.png) no-repeat -407px -159px #4f7cfc;
